          ...
          <TouchableOpacity key={animal.id} style={styles.item}>
            <View style={styles.listAnimalContainer}>
              ...
              <View style={styles.listAnimalInfos}>
                  ...
                  <Text style={styles.listAnimal}>Longueur min (en m) : {animal.length_min}, Longueur max (en m): {animal.length_max}</Text>
                  <Text style={styles.listAnimal}>Poids min (en kg) : {animal.weight_min}, Poids max (en kg): {animal.weight_max}</Text>
